...
with(x, {
  plot( x$datetime, as.numeric(levels(x$Global_active_power))[x$Global_active_power],type="l",main='',xlab="",ylab="Global Active Power" )
  plot( x$datetime, as.numeric(levels(x$Voltage))[x$Voltage],type="l",main='',xlab="datetime",ylab="Voltage" )
  ...
  plot( x$datetime, as.numeric(levels(x$Global_reactive_power))[x$Global_reactive_power],type="l",main='',xlab="datetime",ylab="Global Reactive Power" )
